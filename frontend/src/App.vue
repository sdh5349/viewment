    ...
    <v-col lg="4" md="4" sm="6">
      ...
      <v-stepper class="stepper-container" v-model="e6" vertical>
        ...
        <v-stepper-content step="2" class="my-0 py-0">
          <v-card color="lighten-1" class="" height="30vh" elevation='0'>
  
            <v-textarea height="50px" placeholder="추억을 적어주세요!" type="text" label="게시 글 입력" v-model="contents" outlined></v-textarea>
